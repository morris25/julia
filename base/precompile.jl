...
precompile(Tuple{Type{Pkg3.Display.VerInfo}, Base.SHA1, Base.VersionNumber})
...
precompile(Tuple{Type{Pkg3.Types.Context}})
...
precompile(Tuple{typeof(Base.Printf.fix_dec), Base.GenericIOBuffer{Array{UInt8, 1}}, Float64, String, Int64, Int64, Char})
precompile(Tuple{typeof(Base.Printf.print_fixed), Base.GenericIOBuffer{Array{UInt8, 1}}, Int64, Int32, Int32, Bool})
...
precompile(Tuple{typeof(Base.convert), Type{Pkg3.Types.PackageSpec}, Pkg3.Types.PackageSpec})
...
precompile(Tuple{typeof(Base.indexed_next), Tuple{Pkg3.Types.Context, Nothing}, Int64, Int64})
...
precompile(Tuple{typeof(Base.push!), Array{Tuple{Base.UUID, String, Base.SHA1, String}, 1}, Tuple{Base.UUID, String, Base.SHA1, String}})
...
precompile(Tuple{typeof(Base.put!), Base.Channel{Any}, Tuple{Pkg3.Types.Context, Nothing}})
...
precompile(Tuple{typeof(Base.start), Tuple{Pkg3.Types.Context, Nothing}})
...
precompile(Tuple{typeof(Core.Compiler.getindex), Type{Any}, GlobalRef, Float64, Core.SlotNumber, Core.SlotNumber, Expr})
...
precompile(Tuple{typeof(Pkg3.REPLMode.do_build!), Pkg3.Types.Context, Vector{Pkg3.REPLMode.Token}})
precompile(Tuple{typeof(Pkg3.REPLMode.do_gc!), Pkg3.Types.Context, Vector{Pkg3.REPLMode.Token}})
precompile(Tuple{typeof(Pkg3.REPLMode.do_help!), Pkg3.Types.Context, Vector{Pkg3.REPLMode.Token}, REPL.LineEditREPL})
precompile(Tuple{typeof(Pkg3.REPLMode.do_init!), Pkg3.Types.Context, Vector{Pkg3.REPLMode.Token}})
...
precompile(Tuple{typeof(Pkg3.REPLMode.do_test!), Pkg3.Types.Context, Vector{Pkg3.REPLMode.Token}})
precompile(Tuple{typeof(Pkg3.REPLMode.do_up!), Pkg3.Types.Context, Vector{Pkg3.REPLMode.Token}})
precompile(Tuple{typeof(Pkg3.REPLMode.do_checkout!), Pkg3.Types.Context, Vector{Pkg3.REPLMode.Token}})
precompile(Tuple{typeof(Pkg3.REPLMode.do_free!), Pkg3.Types.Context, Vector{Pkg3.REPLMode.Token}})
precompile(Tuple{typeof(Pkg3.REPLMode.do_pin!), Pkg3.Types.Context, Vector{Pkg3.REPLMode.Token}})
